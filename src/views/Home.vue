        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad "Higiene y Seguridad en el Trabajo con Infantes" aborda la identificación, evaluación y control de peligros en entornos escolares. Enseña a reconocer factores de riesgo físicos, químicos, biológicos y humanos que pueden afectar a infantes y personal educativo. Destaca la necesidad de prevenir accidentes mediante estrategias planificadas, formación continua y planes de emergencia adaptados a la primera infancia. Se promueve la creación de espacios seguros y protectores, y se enfatiza la responsabilidad compartida entre instituciones, educadores y familias en la construcción de una cultura de prevención y bienestar infantil.
